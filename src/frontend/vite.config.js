...
function manualChunks(id) {
    ...
    if (normalizedId.includes("/src/app/components/common/") ||
        normalizedId.includes("/src/app/components/pm/")) {
        return "feature-pm-common";
    }
    if (normalizedId.includes("/src/app/components/arsenal/") ||
        normalizedId.includes("/src/app/components/court/")) {
        return "feature-visual";
    }
    if (normalizedId.includes("/src/app/components/PtyDrawer.tsx") ||
