...
// Store Creation
// ============================================================================
export const useLLMStore = create()(immer((set, get) => {
    // 用于保存的refs
    let llmConfigRef = null;
    let llmSavePendingRef = null;
    let llmSaveQueueRef = Promise.resolve(true);
    return {
        // ============ 初始状态 ============
        llmConfig: null,
        llmStatus: null,
...
/** Provider 模型列表 */
export const useProviderModels = (providerId) => useLLMStore((state) => state.providerModels[providerId]);
/** Provider Key 状态 */
export const useProviderKeyStatus = (providerId) => useLLMStore((state) => state.providerKeyStatus[providerId]);
