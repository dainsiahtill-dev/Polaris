 ...
 */
export function downloadFile(content, downloadFilename, mimeType) {
 ...
 */
export function logsToJSON(logs, options) {
 ...
 */
export function logsToCSV(logs, options) {
    const maxRows = options?.maxRows ?? logs.length;
 ...
 */
export function generateExportFilename(base, format) {
