...
import { chatCompleteContent, chatErrorMessage, normalizeRuntimeChatEvent, } from './roleChatProtocol';
 ...
 * ```
 */
export function useRoleChat(options) {
    ...
    const channelUnsubscribeRef = useRef(null);
    ...
    const sendMessage = useCallback(async () => {
        ...
        try {
            ...
            messageHandlerUnregisterRef.current = registerMessageHandler((raw) => {
...
function handleStreamEvent(event, messageId, setMessages) {
