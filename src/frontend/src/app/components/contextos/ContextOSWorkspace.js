...
import { Network, ChevronLeft, RefreshCw, Cpu, Database, Layers, GitBranch, Boxes, Gauge, FileStack, ShieldCheck, Radio, ArrowRight, Coins, Activity, X, } from 'lucide-react';
import { Button } from '@/app/components/ui/button';
import { StatusBadge } from '@/app/components/ui/badge';
import { cn } from '@/app/components/ui/utils';
import { workspaceLabel } from '@/app/utils/workspaceDisplay';
import { buildContextOSModel, contextOSFormat, decisionMatchesRole, safeText, summarizeRoleContextState, } from './contextOSData';
...
function RoleInternalEventRow({ event }) {
    const tone = event.category === 'error' ? 'blocked' : event.isProjection || event.hasReceipt ? 'active' : 'idle';
