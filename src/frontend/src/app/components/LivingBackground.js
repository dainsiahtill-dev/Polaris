...
export function LivingBackground() {
    ...
    return (_jsx("canvas", { ref: canvasRef, className: "fixed inset-0 pointer-events-none z-[-1]", style: { background: 'radial-gradient(circle at center, #1a1a1e 0%, #0d0d0e 100%)' } }));
}
