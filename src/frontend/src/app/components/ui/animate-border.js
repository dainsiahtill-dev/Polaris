...
import { m, useMotionValue, useTransform, useAnimationFrame, useMotionTemplate, } from 'framer-motion';
 ...
 *   </AnimateBorder>
 */
export function AnimateBorder({ children, className, glowColor = '#c85040', glowSize = 80, duration = 6, rx = '8', wrapperClassName, showOutline = true, outlineClassName, }) {
    ...
    const getPoint = useCallback((val) => {
        try {
    ...
    return (_jsxs("div", { ref: containerRef, className: cn('relative overflow-hidden', wrapperClassName), children: [showOutline && (_jsx("div", { className: cn('pointer-events-none absolute inset-0 rounded-[inherit] border border-white/10', outlineClassName) })), _jsx("svg", { xmlns: "http://www.w3.org/2000/svg", preserveAspectRatio: "none", width: "100%", height: "100%", className: "pointer-events-none absolute inset-0", "aria-hidden": "true", children: _jsx("rect", { ref: svgRectRef, fill: "none", width: "100%", height: "100%", rx: rx, ry: rx }) }), _jsx(m.span, { "aria-hidden": "true", style: {
                    transform,
                    width: glowSize,
                    height: glowSize,
                    background: `radial-gradient(${glowColor} 0%, transparent 70%)`,
                }, className: "pointer-events-none absolute opacity-70 blur-[6px]" }), _jsx("div", { className: cn('relative', className), children: children })] }));
}
