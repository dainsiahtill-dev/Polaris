...
function CyberInput({ className, type, variant = "default", ...props }: CyberInputProps) {
  const baseStyles = cn(
    ...
    "md:text-sm",
    "border-border bg-[rgba(6,15,28,0.88)]",
    "text-text-main placeholder:text-text-dim",
    "shadow-[inset_0_1px_0_rgba(178,245,255,0.14),inset_0_-1px_0_rgba(0,0,0,0.38)]",
    "hover:border-accent/45 hover:bg-[rgba(10,25,44,0.92)]",
    "focus:border-accent/70 focus:bg-[rgba(10,25,44,0.96)] focus:ring-2 focus:ring-accent/25",
    "disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50",
    "aria-invalid:border-status-error/60 aria-invalid:ring-2 aria-invalid:ring-status-error/20",
    variant === "password" && [
  ...
  return (
    <textarea
      ...
      className={cn(
        ...
        "md:text-sm",
        "border-border bg-[rgba(6,15,28,0.88)] text-text-main placeholder:text-text-dim",
        "shadow-[inset_0_1px_0_rgba(178,245,255,0.14),inset_0_-1px_0_rgba(0,0,0,0.38)]",
        "hover:border-accent/45 hover:bg-[rgba(10,25,44,0.92)]",
        "focus:border-accent/70 focus:bg-[rgba(10,25,44,0.96)] focus:ring-2 focus:ring-accent/25",
        "disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50",
  ...
  return (
    <select
      ...
      className={cn(
        ...
        "border-border bg-[rgba(6,15,28,0.88)] text-text-main",
        "shadow-[inset_0_1px_0_rgba(178,245,255,0.14),inset_0_-1px_0_rgba(0,0,0,0.38)]",
        "hover:border-accent/45 hover:bg-[rgba(10,25,44,0.92)]",
        "focus:border-accent/70 focus:bg-[rgba(10,25,44,0.96)] focus:ring-2 focus:ring-accent/25",
        "disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50",
