...
export function resolveModelName(context) {
    ...
    if (roleConfig?.model) {
        ...
        const roleProviderId = typeof roleConfig.provider_id === 'string' ? roleConfig.provider_id.trim() : '';
        const providerMatchesRole = !providerId || !roleProviderId || roleProviderId === providerId;
...
export function validateModelName(model, _providerType) {
...
export function getModelResolutionLog(context) {
