...
export function CustomEdge(props) {
    ...
    const stroke = props.data?.kind
        ...
        : "#94a3b8";
    return (_jsx(BaseEdge, { id: props.id, path: edgePath, labelX: labelX, labelY: labelY, label: props.label, labelStyle: props.labelStyle, labelShowBg: props.labelShowBg, labelBgStyle: props.labelBgStyle, labelBgPadding: props.labelBgPadding, labelBgBorderRadius: props.labelBgBorderRadius, style: { ...props.style, stroke, strokeWidth: 2 }, markerStart: props.markerStart, markerEnd: props.markerEnd, interactionWidth: 40 }));
}
