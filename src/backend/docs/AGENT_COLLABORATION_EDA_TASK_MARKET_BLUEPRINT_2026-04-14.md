...
1. `POLARIS_TASK_MARKET_MODE=off|shadow|mainline`
2. `POLARIS_TASK_MARKET_BACKEND=sqlite|postgres`
3. `POLARIS_TASK_MARKET_REQUIRE_BLUEPRINT=true|false`
4. `POLARIS_TASK_MARKET_MAX_ATTEMPTS=<int>`
...
1. `POLARIS_TASK_MARKET_MODE=off|shadow|mainline`
2. `POLARIS_TASK_MARKET_STORE=sqlite|postgres`
3. `POLARIS_TASK_MARKET_DESIGN_VISIBILITY_TIMEOUT_SECONDS`
4. `POLARIS_TASK_MARKET_EXEC_VISIBILITY_TIMEOUT_SECONDS`
5. `POLARIS_TASK_MARKET_QA_VISIBILITY_TIMEOUT_SECONDS`
6. `POLARIS_TASK_MARKET_MAX_ATTEMPTS`
7. `POLARIS_TASK_MARKET_REQUIRE_BLUEPRINT`
8. `POLARIS_TASK_MARKET_ENABLE_SAFE_PARALLEL_DIRECTOR`
