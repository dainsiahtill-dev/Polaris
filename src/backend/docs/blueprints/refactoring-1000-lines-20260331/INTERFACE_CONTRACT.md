...
```python
# 环境变量
POLARIS_TOOL_LOOP_MAX_TOTAL_CALLS=64
POLARIS_TOOL_LOOP_MAX_STALL_CYCLES=2
POLARIS_TOOL_LOOP_MAX_WALL_TIME_SECONDS=900
POLARIS_DIRECTOR_LLM_TIMEOUT_SECONDS=600
```
