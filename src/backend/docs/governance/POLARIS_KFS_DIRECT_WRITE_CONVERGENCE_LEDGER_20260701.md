...
| Class | Count | Meaning |
| --- | ---: | --- |
| Closed in this convergence pass | 5 | Owner surfaces migrated to KFS and verified with focused tests. |
| P1 open | 2 | Execution, repair, or platform-control write paths close to runtime correctness. |
