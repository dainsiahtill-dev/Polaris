...
| Class | Count | Meaning |
| --- | ---: | --- |
| Closed in this convergence pass | 6 | Owner surfaces migrated to KFS and verified with focused tests. |
| P1 open | 1 | Platform-control write paths close to runtime correctness. |
