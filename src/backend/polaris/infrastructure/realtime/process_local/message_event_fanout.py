...
class RuntimeEventFanout:
    ...
    def _build_file_edit_event(self, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "diff_status": str(payload.get("diff_status") or "").strip() or None,
            "patch_unavailable_reason": str(payload.get("patch_unavailable_reason") or "").strip() or None,
            "has_patch": bool(payload.get("has_patch")) if "has_patch" in payload else None,
