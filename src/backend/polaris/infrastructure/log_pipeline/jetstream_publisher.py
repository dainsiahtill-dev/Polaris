...
_DEFAULT_QUEUE_SIZE = max(
    ...
    int(
        ...
        or os.environ.get("POLARIS_JETSTREAM_PUBLISH_QUEUE_SIZE", "4096")
    ),
)
_DEFAULT_RETRY_ATTEMPTS = max(
    ...
    int(
        ...
        or os.environ.get("POLARIS_JETSTREAM_PUBLISH_MAX_ATTEMPTS", "6")
    ),
)
_DEFAULT_RETRY_BASE_SEC = max(
    ...
    float(
        ...
        or os.environ.get("POLARIS_JETSTREAM_PUBLISH_RETRY_BASE_SEC", "0.25")
    ),
)
_DEFAULT_RETRY_MAX_SEC = max(
    ...
    float(
        ...
        or os.environ.get("POLARIS_JETSTREAM_PUBLISH_RETRY_MAX_SEC", "5.0")
    ),
)
