...
from .chief_engineer import router as chief_engineer_router
...
from .runtime_diagnostics import router as runtime_diagnostics_router
...
router.include_router(chief_engineer_router)
