...
_POLARIS_TO_KERNELONE: dict[str, str] = {
    ...
    # ─── Platform verifier policy ──────────────────────────────────────────
    "POLARIS_VERIFIER_BROWSER_ENABLED": "KERNELONE_VERIFIER_BROWSER_ENABLED",
    "POLARIS_VERIFIER_VISUAL_ENABLED": "KERNELONE_VERIFIER_VISUAL_ENABLED",
    "POLARIS_VERIFIER_MULTIMODAL_LLM_ENABLED": "KERNELONE_VERIFIER_MULTIMODAL_LLM_ENABLED",
    "POLARIS_VERIFIER_USER_SCRIPTS_ENABLED": "KERNELONE_VERIFIER_USER_SCRIPTS_ENABLED",
    "POLARIS_VERIFIER_DOMAIN_ENABLED": "KERNELONE_VERIFIER_DOMAIN_ENABLED",
    "POLARIS_VERIFIER_REQUIRED_MODALITIES": "KERNELONE_VERIFIER_REQUIRED_MODALITIES",
    # ─── Events / dedup ─────────────────────────────────────────────────────
