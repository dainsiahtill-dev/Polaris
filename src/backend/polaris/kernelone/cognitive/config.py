...
# Risk thresholds
RISK_BYPASS_THRESHOLD = float(os.environ.get("KERNELONE_RISK_BYPASS_THRESHOLD", "0"))
RISK_FAST_THINK_THRESHOLD = float(os.environ.get("KERNELONE_RISK_FAST_THINK_THRESHOLD", "1"))
UNCERTAINTY_FULL_PIPE_THRESHOLD = float(os.environ.get("KERNELONE_UNCERTAINTY_THRESHOLD", "0.6"))

# Rollback config
MAX_ROLLBACK_STEPS = 3

# Thinking phase config
MAX_THINKING_TIME_SECONDS = float(os.environ.get("KERNELONE_MAX_THINKING_TIME", "30.0"))
ENABLE_DEVILS_ADVOCATE = os.environ.get("KERNELONE_ENABLE_DEVILS_ADVOCATE", "1") not in ("0", "false")

# Governance thresholds
GOVERNANCE_CONFIDENCE_HIGH_RISK = float(os.environ.get("COGNITIVE_GOVERNANCE_HIGH_RISK", "0.7"))
GOVERNANCE_CONFIDENCE_MEDIUM_RISK = float(os.environ.get("COGNITIVE_GOVERNANCE_MEDIUM_RISK", "0.5"))
GOVERNANCE_CONFIDENCE_LOW_RISK = float(os.environ.get("COGNITIVE_GOVERNANCE_LOW_RISK", "0.3"))

# Evolution thresholds
EVOLUTION_RECURRENCE_THRESHOLD = int(os.environ.get("COGNITIVE_EVOLUTION_RECURRENCE_THRESHOLD", "3"))
EVOLUTION_CALIBRATION_WINDOW = int(os.environ.get("COGNITIVE_EVOLUTION_CALIBRATION_WINDOW", "50"))
