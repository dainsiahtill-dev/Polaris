...
def main():
    ...
    if args.diagnose:
        ...
        print()
        print("--- Configuration ---")
        env_enabled = os.environ.get("KERNELONE_ENABLE_COGNITIVE_MIDDLEWARE", "not set")
        print(f"KERNELONE_ENABLE_COGNITIVE_MIDDLEWARE: {env_enabled}")
        print()
        ...
        print("  export KERNELONE_ENABLE_COGNITIVE_MIDDLEWARE=true")
        print()
