    ...
    *,
    ...
    return {
        ...
        "structured_evidence": {
            ...
            "failure_evidence": bool(request_metadata_summary.get("has_failed_gate_evidence")),
            "workspace_quality_evidence": bool(request_metadata_summary.get("has_workspace_quality_evidence")),
            "quality_evidence": bool(request_metadata_summary.get("has_workspace_quality_evidence")),
