...
KERNEL_TO_TURN_ENGINE_STALL_THRESHOLD_ENV = "KERNELONE_TOOL_LOOP_MAX_STALL_CYCLES"
KERNEL_TO_TURN_ENGINE_MAX_TOOL_CALLS_ENV = "KERNELONE_TOOL_LOOP_MAX_TOTAL_CALLS"
KERNEL_TO_TURN_ENGINE_MAX_WALL_TIME_ENV = "KERNELONE_TOOL_LOOP_MAX_WALL_TIME_SECONDS"
