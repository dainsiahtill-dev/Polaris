"""Read-only materialization-quality evidence projection ports.

This module projects adapter callback results into migration debt, scheduler
bridge, dark-launch, and receipt lifecycle evidence. It does not execute repair
callbacks or write workspace files.
"""
