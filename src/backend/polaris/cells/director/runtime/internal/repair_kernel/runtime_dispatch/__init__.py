...
from ._handlers_plan import (
    ...
    _plan_go_missing_stdlib_import,
    _plan_go_missing_stdlib_import_typed,
    _plan_go_module_import,
    _plan_go_nested_import,
    _plan_go_printf_stringer,
    _plan_go_printf_stringer_typed,
    _plan_go_subpath_import,
    _plan_go_test_assertion_align,
    _plan_go_test_assertion_align_typed,
    _plan_go_undefined_selector,
    _plan_go_undefined_selector_typed,
...
from ._handlers_run import (
    ...
    _run_go_missing_stdlib_import,
    _run_go_missing_stdlib_import_typed,
    _run_go_module_import,
    _run_go_nested_import,
    _run_go_printf_stringer,
    _run_go_printf_stringer_typed,
    _run_go_subpath_import,
    _run_go_test_assertion_align,
    _run_go_test_assertion_align_typed,
    _run_go_undefined_selector,
    _run_go_undefined_selector_typed,
...
_TYPESCRIPT_RUNTIME_MIGRATION_BINDINGS: tuple[tuple[str, str, str], ...] = (
    ...
    (TYPESCRIPT_TIMER_HANDLE_SOURCE_TOOL, "typescript", "typescript.timer_handle"),
...
_RUNTIME_REPAIR_BINDINGS: dict[str, RuntimeRepairBinding] = {
    ...
    GO_MISSING_STDLIB_IMPORT_SOURCE_TOOL: RuntimeRepairBinding(
        source_tool=GO_MISSING_STDLIB_IMPORT_SOURCE_TOOL,
        language="go",
        rule_id="go.missing_stdlib_import",
        planner=_plan_go_missing_stdlib_import,
        runner=_run_go_missing_stdlib_import,
        typed_planner=_plan_go_missing_stdlib_import_typed,
        typed_runner=_run_go_missing_stdlib_import_typed,
    ),
    GO_UNDEFINED_SELECTOR_SOURCE_TOOL: RuntimeRepairBinding(
        source_tool=GO_UNDEFINED_SELECTOR_SOURCE_TOOL,
        language="go",
        rule_id="go.undefined_selector_alias",
        planner=_plan_go_undefined_selector,
        runner=_run_go_undefined_selector,
        typed_planner=_plan_go_undefined_selector_typed,
        typed_runner=_run_go_undefined_selector_typed,
    ),
    GO_PRINTF_STRINGER_SOURCE_TOOL: RuntimeRepairBinding(
        source_tool=GO_PRINTF_STRINGER_SOURCE_TOOL,
        language="go",
        rule_id="go.printf_stringer_method",
        planner=_plan_go_printf_stringer,
        runner=_run_go_printf_stringer,
        typed_planner=_plan_go_printf_stringer_typed,
        typed_runner=_run_go_printf_stringer_typed,
    ),
    GO_TEST_ASSERTION_ALIGN_SOURCE_TOOL: RuntimeRepairBinding(
        source_tool=GO_TEST_ASSERTION_ALIGN_SOURCE_TOOL,
        language="go",
        rule_id="go.test_assertion_align",
        planner=_plan_go_test_assertion_align,
        runner=_run_go_test_assertion_align,
        typed_planner=_plan_go_test_assertion_align_typed,
        typed_runner=_run_go_test_assertion_align_typed,
    ),
