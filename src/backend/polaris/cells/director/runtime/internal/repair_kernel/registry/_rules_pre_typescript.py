...
def pre_typescript_repair_rules() -> tuple[RepairRuleDefinition, ...]:
    ...
    return (
        ...
        RepairRuleDefinition(
            ...
            archetype=RepairArchetype.MISSING_DEPENDENCY,
            priority=0,
            diagnostic_codes=("rust_e0433", "rust_e0432"),
        ...
        RepairRuleDefinition(
            ...
            diagnostic_codes=("rust_e0433", "rust_e0463"),
            message_any_terms=(
                "cannot find crate",
                "can't find crate",
        ...
        RepairRuleDefinition(
            ...
            risk_level="low",
            description=(
                "Covers unresolved nested crate imports caused by an empty inline "
                "lib.rs module shadowing src/<module>/mod.rs."
            ),
            runtime_plan_available=True,
            metadata={
                "rule_status": "executable_runtime",
                ...
                "executable_runtime_binding": True,
                "planner_helper_available": True,
                "runtime_plan_scope": "inline_empty_module_to_directory_mod",
                "adapter_materialization_runner": False,
            },
        ),
        RepairRuleDefinition(
        ...
        RepairRuleDefinition(
            ...
            archetype=RepairArchetype.MISSING_METHOD_SELF,
            priority=2,
            diagnostic_codes=("rust_e0616",),
            raw_terms=("private field", "help:", "method"),
            risk_level="low",
            description="Applies rustc help to call a same-named method when a struct field is private.",
            runtime_plan_available=True,
        ),
        RepairRuleDefinition(
        ...
        RepairRuleDefinition(
            rule_id="rust.generic_angle_residue",
            source_tool=RUST_LINE_SUGGESTION_SOURCE_TOOL,
            language="rust",
            phase="code_repair",
            archetype=RepairArchetype.GENERATED_RESIDUE,
            priority=1,
            diagnostic_codes=("rust_diagnostic", "rust_e0425"),
            raw_terms=("expected identifier", "found `"),
            risk_level="low",
            description="Removes leaked XML generic close tags and restores Vec<T> from VecT.",
            runtime_plan_available=True,
        ),
        RepairRuleDefinition(
            rule_id="rust.vec_bare_generic",
            source_tool=RUST_LINE_SUGGESTION_SOURCE_TOOL,
            language="rust",
            phase="code_repair",
            archetype=RepairArchetype.INVALID_IDENTIFIER,
            priority=1,
            diagnostic_codes=("rust_e0425",),
            raw_terms=("cannot find type", "Vec"),
            risk_level="low",
            description="Restores Vec<T> when rustc cannot find a VecT identifier next to Vec::new().",
            runtime_plan_available=True,
        ),
        RepairRuleDefinition(
            rule_id="rust.integer_is_finite",
            source_tool=RUST_LINE_SUGGESTION_SOURCE_TOOL,
            language="rust",
            phase="code_repair",
            archetype=RepairArchetype.MISSING_METHOD_SELF,
            priority=2,
            diagnostic_codes=("rust_e0599",),
            message_terms=("is_finite",),
            risk_level="low",
            description="Removes invalid integer .is_finite() guards proven by rustc E0599.",
            runtime_plan_available=True,
        ),
        RepairRuleDefinition(
            rule_id="rust.unknown_enum_variant",
            source_tool=RUST_LINE_SUGGESTION_SOURCE_TOOL,
            language="rust",
            phase="code_repair",
            archetype=RepairArchetype.MISSING_METHOD_SELF,
            priority=2,
            diagnostic_codes=("rust_e0599",),
            message_terms=("no variant", "found for enum"),
            risk_level="low",
            description="Rewrites rustc E0599 unknown enum variants to a unique similar variant or a match wildcard.",
            runtime_plan_available=True,
        ),
        RepairRuleDefinition(
            rule_id="rust.tuple_arity",
            source_tool=RUST_LINE_SUGGESTION_SOURCE_TOOL,
            language="rust",
            phase="code_repair",
            archetype=RepairArchetype.MISSING_METHOD_SELF,
            priority=2,
            diagnostic_codes=("rust_e0308",),
            message_terms=("tuple", "elements"),
            risk_level="low",
            description="Widens a 2-tuple let-binding when rustc expects 3 elements.",
            runtime_plan_available=True,
        ),
        RepairRuleDefinition(
            rule_id="rust.enum_variant_missing_field",
            source_tool=RUST_LINE_SUGGESTION_SOURCE_TOOL,
            language="rust",
            phase="code_repair",
            archetype=RepairArchetype.MISSING_METHOD_SELF,
        ...
        RepairRuleDefinition(
            rule_id="rust.test_assertion_local_structure",
            source_tool=RUST_LINE_SUGGESTION_SOURCE_TOOL,
            language="rust",
            phase="target_runtime",
            archetype=RepairArchetype.RUNTIME_CONTRACT,
            priority=2,
            diagnostic_codes=("verifier_test_failure",),
            raw_terms=("panicked at",),
            risk_level="low",
            description="Applies local structure fixes proven by cargo test assertion residuals.",
            runtime_plan_available=True,
        ),
        RepairRuleDefinition(
