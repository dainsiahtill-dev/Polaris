"""Base activity primitives for Workflow workers."""
...
_REGISTERED_ACTIVITIES: dict[str, Callable[..., Any]] = {}


def register_activity(name: str) -> Callable[[Callable[..., Any]], Callable[..., Any]]:
