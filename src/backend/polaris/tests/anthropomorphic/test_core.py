...
if importlib.util.find_spec("polaris.cells.runtime.projection.internal.anthropomorphic") is None:
    pytest.skip("Module not available: polaris.cells.runtime.projection.internal.anthropomorphic", allow_module_level=True)
...
from polaris.cells.runtime.projection.internal.anthropomorphic import MemoryItem, MemoryStore
