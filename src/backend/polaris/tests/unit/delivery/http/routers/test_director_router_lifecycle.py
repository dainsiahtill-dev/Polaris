"""Director lifecycle + status + diagnostics router tests (start/stop/status/diagnostics).

Split from the historical test_v2_director_router.py Director Lifecycle section."""
