...
class TestInterviewRouterCurrentBehaviour:
    """Document current router behaviour (known TYPE_CHECKING forward-ref issue)."""

    def test_interview_ask_returns_422_due_to_forward_ref(self) -> None:
        """POST /llm/interview/ask returns 422 because payload is a ForwardRef."""
    ...
    def test_interview_save_returns_422_due_to_forward_ref(self) -> None:
        """POST /llm/interview/save returns 422 because payload is a ForwardRef."""
        client = _build_client()
        response = client.post(
            "/llm/interview/save",
            json={
    ...
    def test_interview_cancel_returns_422_due_to_forward_ref(self) -> None:
        """POST /llm/interview/cancel returns 422 because payload is a ForwardRef."""
        client = _build_client()
        response = client.post(
    ...
    def test_interview_stream_returns_422_due_to_forward_ref(self) -> None:
        """POST /llm/interview/stream returns 422 because payload is a ForwardRef."""
        client = _build_client()
        response = client.post(
