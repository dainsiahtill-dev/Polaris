...
- **拟人化协商内核**：through role-based dialogue (PM/Chief Engineer/Director/QA) to turn failures into negotiation and repair actions，避免单线路僵死；目标是降低人工介入频次，而不是增加“表演式对话”。
...
### Director Capability Gate (Engineering Permission Matrix)
...
### ChiefEngineer Role (Chief Engineer)
